...
.field bE:Landroid/database/Cursor;

.field final by:Landroid/support/v4/content/Loader$ForceLoadContentObserver;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method a(Landroid/database/Cursor;Landroid/database/ContentObserver;)V
    ...
    iget-object v0, p0, Landroid/support/v4/content/CursorLoader;->by:Landroid/support/v4/content/Loader$ForceLoadContentObserver;
...
.method public deliverResult(Landroid/database/Cursor;)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/content/CursorLoader;->bE:Landroid/database/Cursor;

    iput-object p1, p0, Landroid/support/v4/content/CursorLoader;->bE:Landroid/database/Cursor;
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, Landroid/support/v4/content/CursorLoader;->bz:Landroid/net/Uri;
    ...
    iget-object v0, p0, Landroid/support/v4/content/CursorLoader;->bA:[Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/support/v4/content/CursorLoader;->bB:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/support/v4/content/CursorLoader;->bC:[Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/support/v4/content/CursorLoader;->bD:Ljava/lang/String;
    ...
    iget-boolean v0, p0, Landroid/support/v4/content/CursorLoader;->bI:Z
...
.method public loadInBackground()Landroid/database/Cursor;
    ...
    iget-object v1, p0, Landroid/support/v4/content/CursorLoader;->bz:Landroid/net/Uri;

    iget-object v2, p0, Landroid/support/v4/content/CursorLoader;->bA:[Ljava/lang/String;

    iget-object v3, p0, Landroid/support/v4/content/CursorLoader;->bB:Ljava/lang/String;

    iget-object v4, p0, Landroid/support/v4/content/CursorLoader;->bC:[Ljava/lang/String;

    iget-object v5, p0, Landroid/support/v4/content/CursorLoader;->bD:Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/support/v4/content/CursorLoader;->by:Landroid/support/v4/content/Loader$ForceLoadContentObserver;
...
.method protected onReset()V
    ...
    iput-object v0, p0, Landroid/support/v4/content/CursorLoader;->bE:Landroid/database/Cursor;
