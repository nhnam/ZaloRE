...
.field protected fq:[I

.field private fr:I

.field private fs:Landroid/support/v4/widget/SimpleCursorAdapter$CursorToStringConverter;

.field private ft:Landroid/support/v4/widget/SimpleCursorAdapter$ViewBinder;
...
.method private a([Ljava/lang/String;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->bE:Landroid/database/Cursor;

    if-eqz v0, :cond_2

    array-length v1, p1

    iget-object v0, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->fp:[I
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->fp:[I
    ...
    iget-object v2, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->fp:[I

    iget-object v3, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->bE:Landroid/database/Cursor;
...
.method public bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    iget-object v4, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->ft:Landroid/support/v4/widget/SimpleCursorAdapter$ViewBinder;

    iget-object v0, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->fq:[I

    array-length v5, v0

    iget-object v6, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->fp:[I

    iget-object v7, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->fq:[I
...
.method public convertToString(Landroid/database/Cursor;)Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->fs:Landroid/support/v4/widget/SimpleCursorAdapter$CursorToStringConverter;
    ...
    :cond_0
    iget v0, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->fr:I
...
.method public swapCursor(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->fu:[Ljava/lang/String;
