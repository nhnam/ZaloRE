...
public class ba extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    try
    {
      ...
      {
        bk localbk = new bk(this.lX, i, j);
        ((GridView)paramView.findViewById(2131297062)).setAdapter(localbk);
        localbk.setOnClickListener(new bb(this));
        return paramView;
        i = paramInt * 10;
      }
    }
 ...
 * Qualified Name:     com.zing.zalo.stickers.ba
