...
public final class bk extends BaseAdapter
{
  ...
  public bk(Activity paramActivity, int paramInt1, int paramInt2)
  {
  ...
  private void g(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      com.zing.zalo.j.a.jh().jn();
      Iterator localIterator;
      if (com.zing.zalo.j.a.jh().jp().size() == 0)
        localIterator = com.zing.zalo.j.a.jh().jl().keySet().iterator();
      while (true)
      {
        if (!localIterator.hasNext())
        {
          localArrayList = new ArrayList(com.zing.zalo.j.a.jh().jp().keySet());
        ...
        com.zing.zalo.j.a.jh().jp().put(str, str);
      }
    }
    ...
    while (true)
    {
      try
      {
        ...
        try
        {
          ...
          str1 = (String)com.zing.zalo.j.a.jh().jp().get(this.VD[paramInt]);
          ...
          {
            ((com.a.a)com.zing.zalo.g.a.AK.j(localEmoticonImageView)).a(str2, com.zing.zalo.g.a.BH);
 ...
 * Qualified Name:     com.zing.zalo.stickers.bk
