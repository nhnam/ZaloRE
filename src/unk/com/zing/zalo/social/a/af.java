...
{
  af(z paramz, g paramg, ArrayList paramArrayList)
  {
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    while (true)
    {
      ...
      try
      {
        if (this.TN.lB() == 12)
        {
          Intent localIntent1 = new Intent(z.a(this.TM), VipAlbumPhotoActivity.class);
          ...
          z.a(this.TM).startActivity(localIntent1);
          return;
        }
        localx = (x)this.Os.get(paramInt);
        if (localx == null)
          break;
        Intent localIntent2 = new Intent(z.a(this.TM), ImageViewActivity.class);
        ...
        if (this.Os.size() > 1)
        {
          ...
          z.a(this.TM).startActivityForResult(localIntent2, 1003);
          return;
        }
      }
 ...
 * Qualified Name:     com.zing.zalo.social.a.af
