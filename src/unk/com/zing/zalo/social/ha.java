...
{
  ha(UpdateStatusActivity paramUpdateStatusActivity)
  {
  }

  public void onClick(View paramView)
  {
    UpdateStatusActivity.v(this.SE).setBackgroundColor(this.SE.getResources().getColor(2131361792));
    UpdateStatusActivity.v(this.SE).setTextColor(this.SE.getResources().getColor(2131361826));
    ...
    UpdateStatusActivity.y(this.SE).setVisibility(0);
 ...
 * Qualified Name:     com.zing.zalo.social.ha
