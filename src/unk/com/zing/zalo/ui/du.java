...
{
  du(ChatActivity paramChatActivity)
  {
  }

  public void onClick(View paramView)
  {
    ChatActivity.V(this.acV).setBackgroundColor(this.acV.getResources().getColor(2131361792));
    ChatActivity.V(this.acV).setTextColor(this.acV.getResources().getColor(2131361826));
 ...
 * Qualified Name:     com.zing.zalo.ui.du
