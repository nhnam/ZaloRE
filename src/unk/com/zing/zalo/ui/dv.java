...
{
  dv(ChatActivity paramChatActivity)
  {
  }
  ...
  public void onClick(View paramView)
  {
    ...
    ChatActivity.W(this.acV).setBackgroundColor(this.acV.getResources().getColor(2131361792));
    ChatActivity.W(this.acV).setTextColor(this.acV.getResources().getColor(2131361826));
    ...
    ChatActivity.aa(this.acV).setVisibility(0);
    ChatActivity.ab(this.acV).setVisibility(0);
 ...
 * Qualified Name:     com.zing.zalo.ui.dv
