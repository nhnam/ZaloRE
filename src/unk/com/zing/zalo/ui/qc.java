  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    while (true)
    {
      ...
      HiddenListActivity.f(qb.a(this.aij)).setText(HiddenListActivity.b(qb.a(this.aij)).getString(2131165918));
      HiddenListActivity.g(qb.a(this.aij)).setVisibility(8);
    }
  }
}

/* Location:           /home/danghvu/0day/Zalo/Zalo_1.0.8_dex2jar.jar
 * Qualified Name:     com.zing.zalo.ui.qc
