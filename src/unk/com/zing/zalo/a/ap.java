...
import com.zing.zalo.component.ChatLeftAnimation;
...
{
  ap(m paramm, com.zing.zalo.d.a parama, b paramb, bc parambc)
  {
  }
  ...
  public void onClick(View paramView)
  {
    if ((this.nt.da() == 4) || (this.nt.da() == 5) || (this.nt.da() == 6))
    {
      if (!this.ns.np.c(this.nt.de(), this.nu.timestamp))
        break label266;
      this.nv.nP.getAnimationVoiceView().bO(2130837533);
      this.ns.np.dP();
    }
    while (true)
    {
      ...
      if ((this.nt.da() != 3) && (this.nt.da() != 1) && (this.nt.da() != 4) && (this.nt.da() != 6) && (!str.contains(".png")) && (!str.contains(".jpg")) && ((this.nt.da() == 2) || (this.nt.da() == 5)))
      {
        ...
        this.nv.nP.getAnimationView().a(this.nt, this.nu.timestamp, true);
      }
      return;
      label266: this.nv.nP.getAnimationVoiceView().pq();
 ...
 * Qualified Name:     com.zing.zalo.a.ap
