...
public class VerifyCodeZMActivity extends BetterActivity
{
  ...
  private boolean checkError()
  {
    ...
    if ((a.Dd == null) || ((a.Dd != null) && (a.Dd.trim().equals(""))))
    {
      p.eK(this.KH.getString(2131165358));
      return false;
    }
    a.De.trim().length();
    if ((a.De == null) || ((a.De != null) && (a.De.trim().length() == 0)))
    {
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.No.setOnClickListener(new aqz(this));
    this.att = ((LinearLayout)findViewById(2131297485));
    this.att.setOnClickListener(new arb(this));
    this.atr = ((LinearLayout)findViewById(2131297484));
    this.atr.setOnClickListener(new arc(this));
    this.atx = new SMSReceiver(new Handler(new ard(this)));
  }
  ...
  public Dialog onCreateDialog(int paramInt)
  {
    ...
    case 0:
      ...
      localv2.bW(localResources2.getString(2131165219)).bV(localResources2.getString(2131165365)).h(localResources2.getString(2131165231), new ari(this));
      return localv2.io();
    case 1:
    }
    Resources localResources1 = getResources();
    v localv1 = new v(this);
    localv1.bW(localResources1.getString(2131165234)).bV(localResources1.getString(2131165939)).h(localResources1.getString(2131165233), new arj(this)).g(localResources1.getString(2131165232), new ara(this));
    return localv1.io();
  }
  ...
  public boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    Intent localIntent = new Intent(this, InputPhoneZMActivity.class);
  ...
  public void ph()
  {
    ...
    do
    {
      ...
      if ((this.Kg != null) && (!this.Kg.isShowing()) && (!isFinishing()))
        this.Kg.show();
      this.agd.a(new are(this));
    }
    while (a.Cr.equals(""));
    this.agd.a(a.Cr, atp, com.zing.zalo.g.c.aP(MainApplication.cx()), a.Df);
  }
}

/* Location:           /home/danghvu/0day/Zalo/Zalo_1.0.8_dex2jar.jar
 * Qualified Name:     com.zing.zalo.ui.VerifyCodeZMActivity
