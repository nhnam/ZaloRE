...
public class InputPhoneFBActivity extends BetterActivity
{
  ...
  public void nI()
  {
    FacebookConnector.getInstance(this).logout(this, new sy(this));
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    while (true)
    {
      ...
      this.ajv.setOnClickListener(new su(this));
      this.ajs = ((LinearLayout)findViewById(2131297154));
      this.ajs.setOnClickListener(new sz(this));
      this.ajt = ((LinearLayout)findViewById(2131297155));
      this.ajt.setOnClickListener(new ta(this));
  ...
  public Dialog onCreateDialog(int paramInt)
  {
    ...
    case 0:
      ...
      n localn = new n(this);
      localn.bS(localResources3.getString(2131165489)).bR("").bQ(this.aju.getText().toString()).d(localResources3.getString(2131165292), new tc(this)).c(localResources3.getString(2131165289), new td(this));
      return localn.im();
    case 1:
      Resources localResources2 = getResources();
      v localv4 = new v(this);
      localv4.bW(localResources2.getString(2131165219)).bV(localResources2.getString(2131165492)).h(localResources2.getString(2131165231), new te(this));
      return localv4.io();
    case 2:
      v localv3 = new v(this);
      localv3.bW(this.KH.getString(2131165234)).bV(this.KH.getString(2131165220)).h(this.KH.getString(2131165233), new tf(this)).g(this.KH.getString(2131165232), new tg(this));
      return localv3.io();
    case 3:
      v localv2 = new v(this);
      localv2.bW(this.KH.getString(2131165184)).bV(this.KH.getString(2131165374)).h(this.KH.getString(2131165231), new sv(this));
      return localv2.io();
    case 4:
    }
    Resources localResources1 = getResources();
    v localv1 = new v(this);
    localv1.bW(localResources1.getString(2131165234)).bV(localResources1.getString(2131165261)).h(localResources1.getString(2131165233), new sw(this)).g(localResources1.getString(2131165232), new sx(this));
    return localv1.io();
  }
 ...
 * Qualified Name:     com.zing.zalo.ui.InputPhoneFBActivity
