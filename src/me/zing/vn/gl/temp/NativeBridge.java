...
import me.zing.vn.gl.GLHelper;
import me.zing.vn.gl.NativeFilter;

public class NativeBridge
{
  public static int RENDER_SIZE_UNSPECIFIED = -1;
  private static NativeBridge.ImageProcessorDelegate aIG = null;
  ...
  public static int getCurrentFilter()
  {
    ...
    return aIG.getCurrentFilter();
  }

  public static int getCurrentRotation()
  {
    return aIG.getCurrentRotation();
  }
  ...
  public static int loadMasterTexture()
  {
    ...
    aIG.onStartLoadMasterTexture();
    Bitmap localBitmap = aIG.getMasterTextureBitmap();
    if (localBitmap == null)
    {
  ...
  {
    aIG = paramImageProcessorDelegate;
  }
 ...
 * Qualified Name:     me.zing.vn.gl.temp.NativeBridge
