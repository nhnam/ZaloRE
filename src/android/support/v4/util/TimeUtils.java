...
public class TimeUtils
{
  ...
  private static char[] cD = new char[24];
  ...
  {
    if (cD.length < paramInt)
      cD = new char[paramInt];
    char[] arrayOfChar = cD;
    if (paramLong == 0L)
    {
      int i28 = paramInt - 1;
    ...
    while (true)
    {
      ...
      while (true)
      {
        if (paramInt != 0)
        {
          ...
          {
            bool4 = true;
            int i17 = i16 + a(i1, 1, bool4, 2);
            if (i17 <= 0)
              break label328;
            bool5 = true;
            int i18 = i17 + a(i3, 1, bool5, 2);
            if (i18 <= 0)
              break label334;
            bool6 = true;
            i19 = i18 + a(i2, 1, bool6, 2);
            if (i19 <= 0)
              break label340;
          }
          label328: label334: label340: for (int i20 = 3; ; i20 = 0)
          {
            int i21 = i19 + (1 + a(j, 2, true, i20));
            i4 = 0;
            int i22 = i21;
            while (i22 < paramInt)
            {
  ...
  public static void a(long paramLong, PrintWriter paramPrintWriter, int paramInt)
  {
    synchronized (cC)
    {
      ...
      paramPrintWriter.print(new String(cD, 0, i));
      return;
    }
  }
}
